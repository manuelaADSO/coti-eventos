<main class="container-fluid my-5 flex-grow-1">
    ...
    <div class="row align-items-center g-5">
        ...
        <div class="col-lg-7">
            <h1 class="display-4 fw-light mb-5">Bautizos</h1>
<p class="lead text-dark fs-4">El bautizo de tu pequeño merece mucho más que una ceremonia: merece convertirse en un recuerdo lleno de fe, amor y significado.
Creamos una atmósfera delicada y especial, donde cada detalle acompaña la pureza de este momento único,
