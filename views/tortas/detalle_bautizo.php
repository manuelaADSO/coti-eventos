...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
           <img id="imagen-principal" src="https://i.pinimg.com/736x/ff/54/0b/ff540b865cd3c87630a9c65b23d9300b.jpg"
        ...
        <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Torta Bautizo</h5>

                <p class="text-muted mt-2 fs-1">
