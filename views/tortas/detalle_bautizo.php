...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
            <img src="https://i.pinimg.com/736x/ff/54/0b/ff540b865cd3c87630a9c65b23d9300b.jpg"
        ...
        <div class="col-md-7 d-flex flex-column justify-content-between">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-5">Torta Bautizo</h5>

                <p class="text-muted mt-5 fs-1">
                Pastel en tonos suaves con detalles religiosos y decoración delicada.
Representa pureza, ternura y un momento especial en familia
                </p>
    ...
    <div class="row mt-4 g-2">
        <div class="col-4">
            <img src="https://i.pinimg.com/736x/67/0a/c6/670ac62dbac20262df3320ed7b10708c.jpg"
                 class="img-fluid rounded">
        </div>

        <div class="col-4">
            <img src="https://i.pinimg.com/736x/ca/a6/48/caa648932be0040c27aece2cab64f0e4.jpg"
                 class="img-fluid rounded">
        </div>

        <div class="col-4">
            <img src="https://i.pinimg.com/1200x/89/09/99/8909994bd9c59619029b658ce4a2e431.jpg"
                 class="img-fluid rounded">
        </div>
    </div>
