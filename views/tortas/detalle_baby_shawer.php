...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
            <img id="imagen-principal" src="https://i.pinimg.com/1200x/4d/61/70/4d61706939ed5577ce4005848133dcdd.jpg"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Torta Baby Shawers</h5>
