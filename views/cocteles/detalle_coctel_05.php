...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
           <img id="imagen-principal" src="https://i.pinimg.com/736x/db/ec/f1/dbecf16b2fa734e9fa00cf0c614a68e0.jpg"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Cóctel atardecer de frutos rojos</h5>
