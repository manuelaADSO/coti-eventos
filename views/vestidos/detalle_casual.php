    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="card border-0">
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <img src="https://i.pinimg.com/736x/c8/fb/60/c8fb60f040beb8767ec55b87376fa6c5.jpg" class="img-fluid rounded-3" alt="Vestido miniatura">
                    </div>
                    <div class="col-6">
                        <img src="https://i.pinimg.com/736x/ad/bd/b1/adbdb1b42c34309c7c8c86ff9731802f.jpg" class="img-fluid rounded-3" alt="Vestido miniatura">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <h1 class="display-1 display-md-3 fw-normal lh-1 mt-5">Vestido Corto Casual</h1>

            <p class="text-muted mt-5 fs-1">
               Vestido hasta la rodilla o un poco más arriba, cómodo y divertido, ideal para cumpleaños informales o fiestas con amigos.
                Puede ser de algodón, lino o mezclas ligeras, y con estampados o colores llamativos.
