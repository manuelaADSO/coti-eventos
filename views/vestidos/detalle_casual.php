         ...
         <div class="row g-4">
             ...
             <div class="col-lg-6">
                 <div class="card border-0">
                     <img id="imagen-principal" src="https://i.pinimg.com/736x/37/1b/46/371b46c01ffc5c556ba9de2bae134795.jpg" class="img-fluid rounded-4 mb-3" alt="Vestido principal">
                 </div>
             </div>
             ...
             <div class="col-lg-6">
                 ...
                 <h1 class="display-4 display-md-3 fw-normal lh-1 mt-2">Vestido Corto Casual</h1>
