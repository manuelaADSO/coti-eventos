    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
                 <div class="card border-0">
                     <img id="imagen-principal" src="https://i.pinimg.com/736x/15/f2/d3/15f2d32c1c1369f8a7b3a19c06a142fa.jpg" class="img-fluid rounded-4 mb-3" alt="Vestido principal">
                 </div>
             </div>
         ...
         <div class="carousel-inner pb-3">
             ...
             <div class="carousel-item active">
                 <div class="d-flex justify-content-center gap-3">
                     <img src="https://i.pinimg.com/1200x/8f/ee/9a/8fee9afc0138e7758b348fbe7ba923d2.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
                     <img src="https://i.pinimg.com/1200x/24/1c/ae/241caed81e17e302494afcc01446f73e.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
