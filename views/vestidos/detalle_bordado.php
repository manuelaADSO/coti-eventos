         ...
         <div class="row g-4">
             ...
             <div class="col-lg-6">
                 <div class="card border-0">
                     <img id="imagen-principal" src="https://i.pinimg.com/1200x/cd/fc/8c/cdfc8ccb5740893c3e5a5a3f000f5e77.jpg" class="img-fluid rounded-4 mb-3" alt="Vestido principal">
                 </div>
             </div>
             ...
             <div class="col-lg-6">
                 ...
                 <h1 class="display-4 display-md-3 fw-normal lh-1 mt-2">Vestido con Encaje o Bordado</h1>

                 <p class="text-muted mt-2 fs-3">
                     Vestido decorado con encaje, bordados o pequeños volantes, aportando un toque romántico y delicado.
                     Ideal para baby showers más formales o temáticos.
                 </p>
         ...
         <div class="carousel-inner pb-3">
             ...
             <div class="carousel-item active">
                 <div class="d-flex justify-content-center gap-3">
                     <img src="https://i.pinimg.com/1200x/d2/58/ac/d258aca64aaf83bad577b440f4b42035.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
                     <img src="https://i.pinimg.com/736x/9e/cf/01/9ecf016f3baf046d19ac33e226e0a818.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
