         ...
         <div class="row g-4">
             ...
             <div class="col-lg-6">
                <div class="card border-0">
                    <img id="imagen-principal" src="https://i.pinimg.com/736x/ef/b2/5e/efb25e0e8909c5004163439ea4144dc9.jpg" class="img-fluid rounded-4 mb-3" alt="Vestido principal">
                </div>
            </div>
         ...
         <div class="carousel-inner pb-3">
             ...
             <div class="carousel-item active">
                 <div class="d-flex justify-content-center gap-3">
                     <img src="https://i.pinimg.com/736x/5e/29/e0/5e29e0e1b35e6d5928d6db13b80b4eff.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
                     <img src="https://i.pinimg.com/1200x/45/b5/0d/45b50d3c2024ed321dcd190f97bdea30.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
