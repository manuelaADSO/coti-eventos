...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
           <img id="imagen-principal" src="https://i.pinimg.com/1200x/a9/5a/e1/a95ae145802d9c053abe032f6904a505.jpg"
        ...
        <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Cheesecake de cereza y chocolate</h5>

                <p class="text-muted mt-2 fs-3">
            Base de galleta de chocolate con relleno cremoso y cobertura de cerezas en salsa brillante.
