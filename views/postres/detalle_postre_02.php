...
<div class="container py-4">
   ...
   <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
          <img id="imagen-principal" src="https://i.pinimg.com/736x/da/59/e6/da59e63dc9f9e2a1eea63809174110fd.jpg"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Tiramisú con frutos rojos</h5>
