...
<div class="container py-4">
   ...
   <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
        <img id="imagen-principal" src="https://i.pinimg.com/1200x/1e/92/70/1e92708d4c30a0c225cd6e2a8d6aac8b.jpg"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Cheesecake de fresa</h5>
