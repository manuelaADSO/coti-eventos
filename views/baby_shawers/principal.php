    ...
    <div id="weddingCarousel" class="carousel slide mb-5 shadow" data-bs-ride="carousel">
        <div class="carousel-inner rounded-4">
            <div class="carousel-item active">
                <img src="https://i.pinimg.com/736x/f2/fe/87/f2fe875cebe2910dd3015e7114090ee4.jpg" class="d-block w-100 object-fit-cover" style="max-height: 450px;" alt="Boda 1">
            </div>
            <div class="carousel-item">
                <img src="https://i.pinimg.com/736x/8a/9c/b8/8a9cb8ea4be31f3cac5aeeed9efc4a76.jpg" class="d-block w-100 object-fit-cover" style="max-height: 450px;" alt="Boda 2">
            </div>
              </div>
    ...
    <div class="row align-items-center g-5">
        ...
        <div class="col-lg-5 text-center">
            <div class="ratio ratio-1x1 mx-auto shadow-lg rounded-circle overflow-hidden" style="max-width: 400px;">
                <img src="https://i.pinimg.com/1200x/65/bf/dc/65bfdc637bcdda5355261f2061092e12.jpg" 
