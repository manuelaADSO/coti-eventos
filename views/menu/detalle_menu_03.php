...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
             <img id="imagen-principal" src="./assets/img/banquete/menu/pollo_salsa.webp"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h1 class="display-1 display-md-3 fw-normal lh-1 mt-2">Pollo en salsa cremosa con papas fritas</h1>
         ...
         <div class="carousel-inner pb-3">
             ...
             <div class="carousel-item active">
                 <div class="d-flex justify-content-center gap-3">
                     <img src="./assets/img/banquete/menu/03_menu/comida_1.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
                     <img src="./assets/img/banquete/menu/03_menu/comida_2.jpg" class="rounded-4" style="width:300px; height:420px; object-fit:cover; cursor:pointer;"
                         onclick="cambiarImagen(this)">
