...
<div class="container py-4">
    ...
    <div class="row g-4">
        ...
        <!-- Imagen principal -->
        <div class="col-md-5">
             <img id="imagen-principal" src="./assets/img/banquete/menu/pollo_cremoso.webp"
        ...
        <!-- Texto y precio -->
         <div class="col-md-7 d-flex flex-column">
            ...
            <div>
                <h5 class="display-1 display-md-3 fw-normal lh-1 mt-2">Pollo en salsa cremosa con pasta fusilli</h5>
